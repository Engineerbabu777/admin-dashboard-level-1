...
import YearlyAnalyticsChart from "../YearlyAnalyticsChart/Main";
import VisitorsAnalytics from "../VisitorsAnalytics";
import DeviceAnalytics from "../DeviceAnalytics";

export default function DashboardLayout({ allVisitors, allProducts }:{allVisitors:any,allProducts:any}) {

    return(<>

<div>
      <div className="grid grid-cols-4 gap-4 md:grid-cols-4 md:gap-6 xl:grid-cols-4 2xl:gap-7">
        <Card
